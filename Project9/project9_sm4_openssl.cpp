...
int main() {
    // 原始数据
    unsigned char plaintext[] = "HelloSM4";
    //unsigned char plaintext[16] = { 0x67, 0x45, 0x23, 0x01, 0xef, 0xcd, 0xab, 0x89,
    ...
    hex_print("Key", key, SM4_KEY_LENGTH);
    hex_print("IV", iv, SM4_BLOCK_SIZE);
